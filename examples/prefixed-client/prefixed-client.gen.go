// Package prefixedclient provides primitives to interact with the openapi HTTP API.
//
// Code generated by github.com/diebietse/oapi-codegen version (devel) DO NOT EDIT.
...
// PrefixedClient which conforms to the OpenAPI3 specification for this service.
...
type ClientOption func(*PrefixedClient) error

// Creates a new PrefixedClient, with reasonable defaults
func NewClient(server string, opts ...ClientOption) (*PrefixedClient, error) {
...
func WithHTTPClient(doer HttpRequestDoer) ClientOption {
	return func(c *PrefixedClient) error {
		c.Client = doer
		return nil
	}
}
...
func (c *PrefixedClient) GetClient(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *PrefixedClient) applyEditors(ctx context.Context, req *http.Request, additionalEditors []RequestEditorFn) error {
