...
//go:generate go run github.com/diebietse/oapi-codegen/cmd/oapi-codegen --config=models.cfg.yaml ../../petstore-expanded.yaml
//go:generate go run github.com/diebietse/oapi-codegen/cmd/oapi-codegen --config=server.cfg.yaml ../../petstore-expanded.yaml
...
import (
	...
	"github.com/diebietse/oapi-codegen/examples/petstore-expanded/echo/api/models"
)
