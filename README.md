...
directory does a lot of that for you. You would run it like so:
    ...
    go install github.com/diebietse/oapi-codegen/cmd/oapi-codegen@latest
...
import (
	...
	"github.com/diebietse/oapi-codegen/examples/petstore-expanded/gin/api"
	middleware "github.com/diebietse/oapi-codegen/pkg/gin-middleware"
)
...
```go
    import (
        "github.com/diebietse/oapi-codegen/pkg/securityprovider"
    )
...
[`/internal/test/externalref/`](https://github.com/diebietse/oapi-codegen/blob/master/internal/test/externalref/externalref.cfg.yaml)
...
generate:
  ...
  embedded-spec: true
import-mapping:
  ./packageA/spec.yaml: github.com/diebietse/oapi-codegen/internal/test/externalref/packageA
  ./packageB/spec.yaml: github.com/diebietse/oapi-codegen/internal/test/externalref/packageB
output: externalref.gen.go
output-options:
  skip-prune: true
```

Have a look at [`cmd/oapi-codegen/oapi-codegen.go`](https://github.com/diebietse/oapi-codegen/blob/master/cmd/oapi-codegen/oapi-codegen.go#L48)
