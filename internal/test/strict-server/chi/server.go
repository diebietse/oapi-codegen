//go:generate go run github.com/diebietse/oapi-codegen/cmd/oapi-codegen --config=server.cfg.yaml ../strict-schema.yaml
//go:generate go run github.com/diebietse/oapi-codegen/cmd/oapi-codegen --config=types.cfg.yaml ../strict-schema.yaml
